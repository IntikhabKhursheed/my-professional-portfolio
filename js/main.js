...
function iconForSocial(label) {
  ...
  if (key === 'linkedin') {
    return '<svg viewBox="0 0 24 24" aria-hidden="true" class="social-icon-svg"><path d="M5.98 3.5A2.48 2.48 0 1 1 6 8.46 2.48 2.48 0 0 1 5.98 3.5ZM4.5 9h3v11h-3V9Zm5.5 0h2.88v1.5h.04A3.16 3.16 0 0 1 15.76 9c3.18 0 3.74 2.09 3.74 4.8V20h-3v-5.36c0-1.28-.02-2.93-1.79-2.93-1.8 0-2.08 1.4-2.08 2.83V20h-3V9Z"/></svg>';
  }
  if (key === 'github') {
    return '<svg viewBox="0 0 24 24" aria-hidden="true" class="social-icon-svg"><path d="M12 2a10 10 0 0 0-3.16 19.49c.5.09.68-.22.68-.48v-1.67c-2.77.6-3.35-1.18-3.35-1.18-.45-1.14-1.11-1.45-1.11-1.45-.91-.63.07-.61.07-.61 1 .07 1.53 1.03 1.53 1.03.9 1.53 2.37 1.09 2.95.83.09-.66.35-1.09.63-1.34-2.21-.25-4.54-1.1-4.54-4.92 0-1.09.39-1.99 1.03-2.69-.1-.26-.45-1.3.1-2.71 0 0 .84-.27 2.75 1.03a9.52 9.52 0 0 1 5 0c1.9-1.3 2.74-1.03 2.74-1.03.56 1.41.21 2.45.11 2.71.64.7 1.02 1.6 1.02 2.69 0 3.83-2.33 4.67-4.55 4.92.36.31.67.92.67 1.86v2.75c0 .26.18.58.69.48A10 10 0 0 0 12 2Z"/></svg>';
  }
  if (key === 'email') {
    return '<svg viewBox="0 0 24 24" aria-hidden="true" class="social-icon-svg"><path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Zm0 3.2V18h16V7.2l-8 5.2-8-5.2Zm8 3.1 8-5.2H4l8 5.2Z"/></svg>';
  }
  if (key === 'whatsapp') {
    return '<svg viewBox="0 0 24 24" aria-hidden="true" class="social-icon-svg"><path d="M12 2a10 10 0 0 0-8.57 15.17L2 22l4.98-1.3A10 10 0 1 0 12 2Zm5.9 14.1c-.24.68-1.2 1.26-1.66 1.33-.42.07-.97.1-1.57-.09-.36-.11-.82-.27-1.42-.53-2.5-1.08-4.13-3.58-4.25-3.75-.11-.16-1-.87-1-1.66 0-.8.42-1.18.57-1.34.15-.16.33-.2.44-.2h.32c.1 0 .23-.04.36.28.13.32.45 1.11.5 1.19.04.09.08.2.01.33-.07.13-.1.21-.2.32-.1.11-.22.25-.32.34-.1.1-.2.21-.08.42.12.2.52.85 1.12 1.38.77.69 1.42.91 1.62 1.01.2.1.32.08.44-.05.13-.13.56-.66.71-.89.14-.23.29-.19.49-.11.2.09 1.28.6 1.5.71.22.11.38.16.44.25.06.09.06.53-.18 1.21Z"/></svg>';
  }
  return '<svg viewBox="0 0 24 24" aria-hidden="true" class="social-icon-svg"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm1 15h-2v-6h2v6Zm0-8h-2V7h2v2Z"/></svg>';
}
